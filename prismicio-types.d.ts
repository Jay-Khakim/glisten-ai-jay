...
/**
 * Item in *Bento → Default → Primary → Groups*
 */
export interface BentoSliceDefaultPrimaryGroupsItem {
  /**
   * Title field in *Bento → Default → Primary → Groups*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.groups[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body  field in *Bento → Default → Primary → Groups*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.groups[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Groups*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.groups[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Groups*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.groups[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
   ...
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: Italic for styling
  ...
  /**
   * Groups field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.groups[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  groups: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryGroupsItem>>;
}
...
/**
 * Item in *CaseStudies → Default → Primary → Case group*
 */
export interface CaseStudiesSliceDefaultPrimaryCaseGroupItem {
  /**
   * Case Study field in *CaseStudies → Default → Primary → Case group*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.case_group[].case_study
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface CaseStudiesSliceDefaultPrimary {
  ...
  /**
   * Case group field in *CaseStudies → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: case_studies.default.primary.case_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  case_group: prismic.GroupField<
    Simplify<CaseStudiesSliceDefaultPrimaryCaseGroupItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryGroupsItem,
      ...
      CaseStudiesSlice,
      CaseStudiesSliceDefaultPrimaryCaseGroupItem,
