...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    <Bounded
      ...
      className="relative"
    >
      <div className="glow absolute -z-10 aspect-square w-full max-w-2xl rounded-full bg-blue-400/20 blur-3xl filter" />
      <AnimatedContent>
        <PrismicRichText
      ...
      <div className="mt-16 grid items-center gap-8 rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12">
        ...
        <PrismicNextImage
          ...
          className={clsx(
            "opacity-90 shadow-2xl lg:col-span-2 lg:px-0",
